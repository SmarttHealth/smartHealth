...
<div
   class="relative  overflow-hidden   bg-blue-500dark:bg-dark py-20 lg:py-[120px]"
   >
      ...
      <div class="flex flex-wrap -mx-4 lg:justify-between">
         <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
               ...
               <p
                  class="text-base leading-relaxed text-body-white dark:text-dark-6 mb-9"
                  >
         ...
         <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div
               class="relative p-8 bg-blue-500 rounded-lg shadow-lg dark:bg-dark-2 sm:p-12"
               >
               <form>
                  <div class="mb-6">
                     <input
